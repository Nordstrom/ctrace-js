...
var cov_23whnq28hw = function () {
  var path = '/Users/a50r/dev/src/github.com/Nordstrom/ctrace-js/src/index.js',
      hash = '3ea78a55b2792bbf580a3be86539303c3e444e66',
      global = new Function('return this')(),
      gcv = '__coverage__',
      coverageData = {
    path: '/Users/a50r/dev/src/github.com/Nordstrom/ctrace-js/src/index.js',
    statementMap: {
      '0': {
        start: {
          line: 6,
...
const tracer = (++cov_23whnq28hw.s[0], Object.assign(new _globalTracer2.default(), opentracing));
++cov_23whnq28hw.s[1];
...
function logFn(level) {
  ...
  return function log(ctx, event, data) {
    ...
    if (level === 'debug') {
      ++cov_23whnq28hw.b[0][0];
      ++cov_23whnq28hw.s[5];

      data = Object.assign({ debug: true }, data);
    } else {
        ++cov_23whnq28hw.b[0][1];
        ++cov_23whnq28hw.s[6];
        if (level === 'error') {
          ++cov_23whnq28hw.b[1][0];
          ++cov_23whnq28hw.s[7];

          data = Object.assign({ error: true }, data);
        } else {
          ++cov_23whnq28hw.b[1][1];
        }
      }++cov_23whnq28hw.s[8];
